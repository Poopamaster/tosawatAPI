...
std=[
    {"id":1,"name":"POOPA","major":"T12","gpa":"3.00"},
    {"id":2,"name":"JAMES","major":"T12","gpa":"3.00"},
    {"id":3,"name":"KENG","major":"T12","gpa":"3.50"},
    {"id":4,"name":"PAD","major":"T12","gpa":"4.00"},
    {"id":5,"name":"PLUEM","major":"T12","gpa":"2.00"}
]
@app.route("/")
def Greet():
